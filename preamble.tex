...
%\setsansfont[Scale=1]{Optima}
%\setsansfont[Scale=1,Mapping=tex-text,BoldFont={Kievit-Bold}]{Kievit-Book}
%\setsansfont[Scale=1,Mapping=tex-text,BoldFont={Optima-Bold},ItalicFont={Optima-Italic}]{Optima-Regular}
